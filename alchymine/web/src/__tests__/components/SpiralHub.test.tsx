...
describe('SpiralHub', () => {
  ...
  it('displays the guided intention prompts', () => {
    render(<SpiralHub />);
    expect(screen.getByText('I want to understand myself better')).toBeInTheDocument();
    expect(screen.getByText('I need to make a financial decision')).toBeInTheDocument();
    expect(screen.getByText("I'm feeling stuck creatively")).toBeInTheDocument();
    ...
    expect(screen.getByText('I want to build generational wealth')).toBeInTheDocument();
    expect(screen.getByText('I want to see things differently')).toBeInTheDocument();
    expect(screen.getByText('I want to improve my relationships')).toBeInTheDocument();
    expect(screen.getByText('I want to find my purpose')).toBeInTheDocument();
    expect(screen.getByText('I want to build a lasting legacy')).toBeInTheDocument();
  });
  ...
  it('shows loading state when an intention is clicked', async () => {
    ...
    expect(screen.getByText('Calculating your optimal path...')).toBeInTheDocument();
  });
  ...
  it('displays recommendations after successful API call', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Today is about understanding your inner world.')).toBeInTheDocument();
    });
