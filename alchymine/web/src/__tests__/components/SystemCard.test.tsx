...
describe('SystemCard', () => {
  ...
  it('displays the description', () => {
    render(<SystemCard {...defaultProps} />);
    expect(screen.getByText('A test system for testing purposes.')).toBeInTheDocument();
  });
  ...
  it('has accessible aria-label', () => {
    render(<SystemCard {...defaultProps} />);
    const link = screen.getByRole('link');
    expect(link).toHaveAttribute('aria-label', 'Test System system - A test system for testing purposes.');
  });
