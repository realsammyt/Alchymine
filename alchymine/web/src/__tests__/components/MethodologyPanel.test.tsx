...
describe('MethodologyPanel', () => {
  ...
  it('is collapsed by default', () => {
    render(<MethodologyPanel {...defaultProps} />);
    expect(screen.queryByText('This is how the test methodology works.')).not.toBeInTheDocument();
  });
  ...
  it('expands when the toggle button is clicked', () => {
    ...
    expect(screen.getByText('This is how the test methodology works.')).toBeInTheDocument();
  });
