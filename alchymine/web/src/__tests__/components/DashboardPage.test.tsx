...
describe('DashboardPage', () => {
  ...
  it('displays the page description', () => {
    render(<DashboardPage />);
    expect(screen.getByText(/Your personal transformation at a glance/)).toBeInTheDocument();
  });
  ...
  it('has a "Begin Discovery" link', () => {
    ...
    expect(discoveryLink.closest('a')).toHaveAttribute('href', '/discover/intake');
  });
  ...
  it('has accessible section landmarks', () => {
    ...
    expect(screen.getByLabelText('Five transformation systems')).toBeInTheDocument();
    expect(screen.getByLabelText('Ethics and transparency')).toBeInTheDocument();
  });
});
