...
const SYSTEMS = [
  {
    ...
    features: ['Numerology Life Path & Expression', 'Natal Chart Analysis', 'Biorhythm Tracking'],
  ...
  },
  {
    ...
    status: 'active' as const,
    features: ['Wealth Archetype', 'Five Levers Strategy', 'Debt Payoff Calculator'],
    gradient: 'from-primary-dark/30 to-primary/20',
  },
  {
  ...
  },
  {
    ...
    status: 'beta' as const,
    features: ['Developmental Frameworks', 'Cognitive Bias Awareness', 'Scenario Planning'],
    gradient: 'from-accent-dark/30 to-accent/20',
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-10">
          ...
          <p className="text-text/50 text-base max-w-2xl">
            Your personal transformation at a glance. Five integrated systems work
            together through a unified profile to support your growth.
          </p>
        </header>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-text/40">
                Complete your discovery assessment to unlock personalized insights
        ...
        <section className="mt-10 card-surface p-5 border-l-2 border-primary/30" aria-label="Ethics and transparency">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-text/40 leading-relaxed">
                All financial calculations are deterministic (never AI-generated).
                Every system includes methodology panels showing evidence levels,
                sources, and calculation types. Your data stays on your
                infrastructure. No dark patterns, no artificial urgency, no
                manipulative design.
              </p>
            </div>
          </div>
